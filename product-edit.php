...
if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
  ...
  $dbproduct->updateproduct( 
    $_POST["productnaam"], $_POST["prijs"], $_POST["descriptie"], $target_file,$_GET["product_id"]);
}
        } catch (Exception $e){
...
<main>
    ...
    <form id="login_form" class="form_class" method="POST" enctype="multipart/form-data">
     ...
     <input class="field_class" type="number" name="prijs" >


    <label for="descriptie">Descriptie:</label>
    <input class="field_class" type="text" name="descriptie" >
